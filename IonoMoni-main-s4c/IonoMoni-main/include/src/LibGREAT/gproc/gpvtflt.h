    ...
    */
    ...
    public:
        ...
        */
        ...
        // provide SION results for external access
       // gpvtflt.h
        //6.6
      
        const std::vector<std::tuple<t_gtime, std::string, par_type, double, std::string>>& get_sion_memory() const { return _sion_memory; }
    ...
    protected:
        ...
        std::vector<std::tuple<t_gtime, std::string, par_type, double, std::string>> _sion_memory;
