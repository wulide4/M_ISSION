...
class DataCalculationPage(QWidget):
    def __init__(self, bus: CommandBus, task_service) -> None:
        ...
        for w in [self.metric_roti, self.metric_aatr, self.metric_iaatr, self.metric_dixsg, self.metric_sigma, self.metric_s4c]:
    ...
    def _metrics(self) -> list[str]:
        mapping = [
            ...
            (self.metric_s4c, MetricKey.S4C.value),
        ]
