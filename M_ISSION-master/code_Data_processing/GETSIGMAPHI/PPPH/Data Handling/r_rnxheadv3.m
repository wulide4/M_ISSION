...
%% Read RINEX Version 3.x Observation File Header
% Function:
%     This function is specifically designed to parse the header of a 
%     RINEX version 3.x observation (OBS) file. It extracts all key 
%     information defined in the header, such as receiver and antenna details, 
%     approximate position, time of observation, and sampling interval.
%
% INPUT:
%     f_obs:    Full path to the RINEX version 3.x observation file.
%
% OUTPUT:
%     inf:      A structure containing all information parsed from the header.
%               - inf.rec:   Receiver information
%               - inf.ant:   Antenna information
%               - inf.time:  Time information (first/last obs, interval, leap seconds, etc.)
%               - inf.nob:   Number of observation types for each system
%               - inf.seq:   Column sequence of key observables for each system (core output)
%% ---------------------------------------------------------------------
