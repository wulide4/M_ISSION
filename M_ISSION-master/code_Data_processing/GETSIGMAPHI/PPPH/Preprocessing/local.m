...
% Function:
%     Calculates the azimuth and elevation angles of a satellite relative to
%     a receiver's local ENU (East-North-Up) frame, given their positions
...
%     dopt:       Option for output units. 0 for radians (default), 1 for degrees.
%
% OUTPUT:
%     azim:       Azimuth angle (clockwise from true North).
%     elev:       Elevation angle (positive up from the horizon).
%% ---------------------------------------------------------------------
narginchk(3,3)
