...
% Function:
%     Calculates the position vector of the Sun in a geocentric coordinate
%     system for a given Modified Julian Date (MJD).
%
% INPUT:
%     mjd:        Modified Julian Date.
%
% OUTPUT:
%     s_pos:      A 3x1 column vector representing the Sun's geocentric
