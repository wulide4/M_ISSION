...
% Function:
%     Calculates the position vector of the Moon in the Earth-Centered,
%     Earth-Fixed (ECEF) coordinate system for a given Modified Julian Date (MJD).
%
% INPUT:
%     mjd:        Modified Julian Date.
%
% OUTPUT:
%     m_pos:      A 3x1 column vector representing the Moon's position [X; Y; Z]
%                 in the ECEF frame, in meters.
%% ---------------------------------------------------------------------
T  = (mjd - 51544.5)/36525;
