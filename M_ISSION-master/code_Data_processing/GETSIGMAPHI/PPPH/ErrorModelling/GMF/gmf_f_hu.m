...
%% Calculate GMF Hydrostatic and Wet Mapping Functions
% Function:
%     Implements the Global Mapping Function (GMF) to compute the hydrostatic
%     and wet mapping functions for tropospheric delay modeling.
%
% INPUT:
%     dmjd:       Modified Julian Date.
%     dlat:       Geodetic latitude of the station, in radians.
%     dlon:       Geodetic longitude of the station, in radians.
%     dhgt:       Ellipsoidal height of the station, in meters.
%     zd:         Satellite zenith distance, in radians.
%
% OUTPUT:
%     gmfh:       GMF hydrostatic mapping function.
%     gmfw:       GMF wet mapping function.
%% ---------------------------------------------------------------------
