...
%% Estimate Tropospheric Parameters using the GPT2 Model
% Function:
%     This function implements the GPT2 (Global Pressure and Temperature 2) model
%     to compute various meteorological parameters for a specific location and time.
%     It utilizes a 5x5 degree grid file (gpt2_5.mat) and performs bilinear
%     interpolation.
%
% INPUT:
...
%     it:         Time variability option (1: for mean values; other: for annual/semiannual variations).
%     opt:        Output option (1: for pressure only; 0: for all parameters).
%
% OUTPUT:
%     p:          Pressure in hectopascals (hPa).
%     T:          Temperature in degrees Celsius (°C).
%     dT:         Temperature lapse rate in Kelvin per kilometer (K/km).
%     e:          Water vapor pressure in hectopascals (hPa).
